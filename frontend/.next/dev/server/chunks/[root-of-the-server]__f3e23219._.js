...
"[project]/lib/seo/metadata.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/(main)/products/data.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$seo$2f$metadata$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/seo/metadata.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$main$292f$products$2f$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/(main)/products/data.ts [app-route] (ecmascript)");
;
;
function sitemap() {
    const staticPages = [
        ...
        '/get-started'
            ...
            url: `${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$seo$2f$metadata$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BASE_URL"]}${route}`,
            lastModified: new Date(),
            changeFrequency: 'monthly',
            priority: route === '' ? 1 : 0.8
        }));
    const dynamicServices = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$main$292f$products$2f$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CATEGORIES"].flatMap((category)=>(category.capabilities || []).map((service)=>({
                url: `${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$seo$2f$metadata$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BASE_URL"]}/services/${category.slug}/${service.slug}`,
                lastModified: new Date(),
                changeFrequency: 'monthly',
                priority: 0.6
            })));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f3e23219._.js.map