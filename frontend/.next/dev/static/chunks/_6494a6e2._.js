...
function AdminCareersPage() {
    ...
    const fetchApplications = async ()=>{
        try {
            const response = await fetch(`${("TURBOPACK compile-time value", "http://localhost:5000")}/api/applications`);
    ...
    const handleStatusChange = async (id, newStatus, triggerEmail, interviewDate)=>{
        try {
            ...
            const response = await fetch(`${("TURBOPACK compile-time value", "http://localhost:5000")}/api/applications/${id}`, {
                method: 'PUT',
                headers: {
...
_s(AdminCareersPage, "qAyITjZvVG2axwr6FYN84OwAUWI=");
_c = AdminCareersPage;
var _c;
